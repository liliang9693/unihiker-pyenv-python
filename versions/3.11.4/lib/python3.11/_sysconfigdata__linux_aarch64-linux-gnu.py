...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/root/.pyenv/versions/3.11.4/bin',
 'BINLIBDEST': '/root/.pyenv/versions/3.11.4/lib/python3.11',
 'BLDLIBRARY': '-L. -lpython3.11',
 'BLDSHARED': 'gcc -pthread -shared -L/root/.pyenv/versions/3.11.4/lib '
              '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib '
              '-L/root/.pyenv/versions/3.11.4/lib '
              '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/root/.pyenv/versions/3.11.4/include',
 'CONFIGURE_LDFLAGS': '-L/root/.pyenv/versions/3.11.4/lib '
                      '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/root/.pyenv/versions/3.11.4' '--enable-shared' "
                "'--libdir=/root/.pyenv/versions/3.11.4/lib' "
                "'LDFLAGS=-L/root/.pyenv/versions/3.11.4/lib "
                "-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib' "
                "'LIBS=-L/root/.pyenv/versions/3.11.4/lib "
                "-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib' "
                "'CPPFLAGS=-I/root/.pyenv/versions/3.11.4/include'",
 'CONFINCLUDEDIR': '/root/.pyenv/versions/3.11.4/include',
 'CONFINCLUDEPY': '/root/.pyenv/versions/3.11.4/include/python3.11',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/tmp/python-build.20250514192755.8031/Python-3.11.4/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/tmp/python-build.20250514192755.8031/Python-3.11.4/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.11 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/root/.pyenv/versions/3.11.4/include '
             '-I/root/.pyenv/versions/3.11.4/include',
 'CXX': 'g++ -pthread',
 ...
 'DESTDIRS': '/root/.pyenv/versions/3.11.4 /root/.pyenv/versions/3.11.4/lib '
             '/root/.pyenv/versions/3.11.4/lib/python3.11 '
             '/root/.pyenv/versions/3.11.4/lib/python3.11/lib-dynload',
 'DESTLIB': '/root/.pyenv/versions/3.11.4/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/root/.pyenv/versions/3.11.4/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/root/.pyenv/versions/3.11.4/include '
                   '/root/.pyenv/versions/3.11.4/include '
                   '/root/.pyenv/versions/3.11.4/include/python3.11 '
                   '/root/.pyenv/versions/3.11.4/include/python3.11',
 'INCLUDEDIR': '/root/.pyenv/versions/3.11.4/include',
 'INCLUDEPY': '/root/.pyenv/versions/3.11.4/include/python3.11',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -L/root/.pyenv/versions/3.11.4/lib '
             '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib '
             '-L/root/.pyenv/versions/3.11.4/lib '
             '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib',
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/root/.pyenv/versions/3.11.4/lib/python3.11',
 'LIBDIR': '/root/.pyenv/versions/3.11.4/lib',
 ...
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -Wsign-compare -DNDEBUG -g -fwrapv -O3 '
                    ...
                    '-I/root/.pyenv/versions/3.11.4/include '
                    '-I/root/.pyenv/versions/3.11.4/include -fPIC -fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/root/.pyenv/versions/3.11.4/lib/pkgconfig',
 'LIBPL': '/root/.pyenv/versions/3.11.4/lib/python3.11/config-3.11-aarch64-linux-gnu',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.11.a',
 'LIBRARY_DEPS': 'libpython3.11.a libpython3.11.so libpython3.so',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lpthread -ldl -L/root/.pyenv/versions/3.11.4/lib '
         '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib -lutil',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'gcc -pthread',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/root/.pyenv/versions/3.11.4/lib/python3.11',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/root/.pyenv/versions/3.11.4/share/man',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                             ...
                             '-I./Include '
                             '-I/root/.pyenv/versions/3.11.4/include '
                             '-I/root/.pyenv/versions/3.11.4/include -fPIC '
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -std=c11 '
                   ...
                   '-I/root/.pyenv/versions/3.11.4/include -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/root/.pyenv/versions/3.11.4/lib '
                    '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib '
                    '-L/root/.pyenv/versions/3.11.4/lib '
                    '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib',
 'PY_CPPFLAGS': '-I. -I./Include -I/root/.pyenv/versions/3.11.4/include '
                '-I/root/.pyenv/versions/3.11.4/include',
 'PY_ENABLE_SHARED': 1,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '-L/root/.pyenv/versions/3.11.4/lib '
               '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib '
               '-L/root/.pyenv/versions/3.11.4/lib '
               '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/root/.pyenv/versions/3.11.4/lib '
                     '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib '
                     '-L/root/.pyenv/versions/3.11.4/lib '
                     '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib',
 ...
 'PY_STDMODULE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall -std=c11 '
                        ...
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I./Include/internal -I. '
                        '-I./Include -I/root/.pyenv/versions/3.11.4/include '
                        '-I/root/.pyenv/versions/3.11.4/include -fPIC',
 'PY_SUPPORT_TIER': 2,
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 1,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/python-build.20250514192755.8031/Python-3.11.4',
 'SCRIPTDIR': '/root/.pyenv/versions/3.11.4/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 'SHLIBS': '-lpthread -ldl -L/root/.pyenv/versions/3.11.4/lib '
           '-Wl,-rpath,/root/.pyenv/versions/3.11.4/lib -lutil',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/python-build.20250514192755.8031/Python-3.11.4 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/python-build.20250514192755.8031/Python-3.11.4 '
 ...
 'VERSION': '3.11',
 'WASM_ASSETS_DIR': './root/.pyenv/versions/3.11.4',
 'WASM_STDLIB': './root/.pyenv/versions/3.11.4/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/tmp/python-build.20250514192755.8031/Python-3.11.4',
 'abs_srcdir': '/tmp/python-build.20250514192755.8031/Python-3.11.4',
 'datarootdir': '/root/.pyenv/versions/3.11.4/share',
 'exec_prefix': '/root/.pyenv/versions/3.11.4',
