...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/root/.pyenv/versions/3.12.7/bin',
 'BINLIBDEST': '/root/.pyenv/versions/3.12.7/lib/python3.12',
 'BLDLIBRARY': '-L. -lpython3.12',
 'BLDSHARED': 'gcc -pthread -shared -L/root/.pyenv/versions/3.12.7/lib '
              '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib '
              '-L/root/.pyenv/versions/3.12.7/lib '
              '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib',
 'BOOTSTRAP_HEADERS': '\\',
 'BUILDEXE': '',
 'BUILDPYTHON': 'python',
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/root/.pyenv/versions/3.12.7/include',
 'CONFIGURE_LDFLAGS': '-L/root/.pyenv/versions/3.12.7/lib '
                      '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/root/.pyenv/versions/3.12.7' '--enable-shared' "
                "'--libdir=/root/.pyenv/versions/3.12.7/lib' "
                "'LDFLAGS=-L/root/.pyenv/versions/3.12.7/lib "
                "-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib' "
                "'LIBS=-L/root/.pyenv/versions/3.12.7/lib "
                "-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib' "
                "'CPPFLAGS=-I/root/.pyenv/versions/3.12.7/include'",
 'CONFINCLUDEDIR': '/root/.pyenv/versions/3.12.7/include',
 'CONFINCLUDEPY': '/root/.pyenv/versions/3.12.7/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/tmp/python-build.20250514193115.20705/Python-3.12.7/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/tmp/python-build.20250514193115.20705/Python-3.12.7/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.12 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/root/.pyenv/versions/3.12.7/include '
             '-I/root/.pyenv/versions/3.12.7/include',
 'CXX': 'g++ -pthread',
 'DEEPFREEZE_C': 'Python/deepfreeze/deepfreeze.c',
 'DEEPFREEZE_DEPS': './Tools/build/deepfreeze.py _bootstrap_python '
                    './Programs/_freeze_module.py \\',
 'DEEPFREEZE_OBJS': 'Python/deepfreeze/deepfreeze.o',
 'DESTDIRS': '/root/.pyenv/versions/3.12.7 /root/.pyenv/versions/3.12.7/lib '
             '/root/.pyenv/versions/3.12.7/lib/python3.12 '
             '/root/.pyenv/versions/3.12.7/lib/python3.12/lib-dynload',
 'DESTLIB': '/root/.pyenv/versions/3.12.7/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/root/.pyenv/versions/3.12.7/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXENAME': '/root/.pyenv/versions/3.12.7/bin/python3.12',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 ...
 'INCLDIRSTOMAKE': '/root/.pyenv/versions/3.12.7/include '
                   '/root/.pyenv/versions/3.12.7/include '
                   '/root/.pyenv/versions/3.12.7/include/python3.12 '
                   '/root/.pyenv/versions/3.12.7/include/python3.12',
 'INCLUDEDIR': '/root/.pyenv/versions/3.12.7/include',
 'INCLUDEPY': '/root/.pyenv/versions/3.12.7/include/python3.12',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'g++ -pthread -shared -L/root/.pyenv/versions/3.12.7/lib '
                '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib '
                '-L/root/.pyenv/versions/3.12.7/lib '
                '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib',
 'LDFLAGS': '-L/root/.pyenv/versions/3.12.7/lib '
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'gcc -pthread -shared -L/root/.pyenv/versions/3.12.7/lib '
             '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib '
             '-L/root/.pyenv/versions/3.12.7/lib '
             '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib',
 'LDVERSION': '3.12',
 'LIBC': '',
 'LIBDEST': '/root/.pyenv/versions/3.12.7/lib/python3.12',
 'LIBDIR': '/root/.pyenv/versions/3.12.7/lib',
 ...
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare '
                    ...
                    '-I/root/.pyenv/versions/3.12.7/include '
                    '-I/root/.pyenv/versions/3.12.7/include -fPIC -fPIC',
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/root/.pyenv/versions/3.12.7/lib/pkgconfig',
 'LIBPL': '/root/.pyenv/versions/3.12.7/lib/python3.12/config-3.12-aarch64-linux-gnu',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.12.a',
 'LIBRARY_DEPS': 'libpython3.12.a libpython3.12.so libpython3.so',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lpthread -ldl -L/root/.pyenv/versions/3.12.7/lib '
         '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib -lutil',
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'gcc -pthread',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/root/.pyenv/versions/3.12.7/lib/python3.12',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/root/.pyenv/versions/3.12.7/share/man',
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g '
                             ...
                             '-I./Include '
                             '-I/root/.pyenv/versions/3.12.7/include '
                             '-I/root/.pyenv/versions/3.12.7/include -fPIC '
 ...
 'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 -Wall '
                   ...
                   '-I/root/.pyenv/versions/3.12.7/include -fPIC '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-L/root/.pyenv/versions/3.12.7/lib '
                    '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib '
                    '-L/root/.pyenv/versions/3.12.7/lib '
                    '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib',
 'PY_CPPFLAGS': '-I. -I./Include -I/root/.pyenv/versions/3.12.7/include '
                '-I/root/.pyenv/versions/3.12.7/include',
 'PY_ENABLE_SHARED': 1,
 'PY_HAVE_PERF_TRAMPOLINE': 1,
 'PY_LDFLAGS': '-L/root/.pyenv/versions/3.12.7/lib '
               '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib '
               '-L/root/.pyenv/versions/3.12.7/lib '
               '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/root/.pyenv/versions/3.12.7/lib '
                     '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib '
                     '-L/root/.pyenv/versions/3.12.7/lib '
                     '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib',
 ...
 'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 '
                        ...
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I./Include/internal -I. '
                        '-I./Include -I/root/.pyenv/versions/3.12.7/include '
                        '-I/root/.pyenv/versions/3.12.7/include -fPIC',
 'PY_SUPPORT_TIER': 2,
 'Py_DEBUG': 0,
 'Py_ENABLE_SHARED': 1,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/python-build.20250514193115.20705/Python-3.12.7',
 'SCRIPTDIR': '/root/.pyenv/versions/3.12.7/lib',
 ...
 'SHELL': '/bin/sh -e',
 'SHLIBS': '-lpthread -ldl -L/root/.pyenv/versions/3.12.7/lib '
           '-Wl,-rpath,/root/.pyenv/versions/3.12.7/lib -lutil',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/python-build.20250514193115.20705/Python-3.12.7 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/python-build.20250514193115.20705/Python-3.12.7 '
 ...
 'VERSION': '3.12',
 'WASM_ASSETS_DIR': './root/.pyenv/versions/3.12.7',
 'WASM_STDLIB': './root/.pyenv/versions/3.12.7/lib/python3.12/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/tmp/python-build.20250514193115.20705/Python-3.12.7',
 'abs_srcdir': '/tmp/python-build.20250514193115.20705/Python-3.12.7',
 'datarootdir': '/root/.pyenv/versions/3.12.7/share',
 'exec_prefix': '/root/.pyenv/versions/3.12.7',
